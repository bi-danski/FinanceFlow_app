...
class _SpendingTrendChartState extends State<SpendingTrendChart> {
  ...
  void didChangeDependencies() {
    ...
    // Ensure TransactionService is obtained here if not already, or if it could change.
    ...
    return FutureBuilder<Map<String, double>>(
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.hasError || !snapshot.hasData || snapshot.data!.isEmpty) {
          return const Center(child: Text('No spending data available to display trend.'));
        }
