...
class _EnhancedInsightsScreenState extends State<EnhancedInsightsScreen> with SingleTickerProviderStateMixin {
  ...
  Widget _buildSpendingPatternDetails(SpendingPatternInsight insight) {
    ...
    return Column(
      ...
      children: [
        ...
        _buildDetailRow('Previous Amount', formatter.format(insight.previousAmount)),
        _buildDetailRow('Current Amount', formatter.format(insight.currentAmount)),
        _buildDetailRow(
          'Change', 
  ...
  Widget _buildBudgetAlertDetails(BudgetAlertInsight insight) {
    ...
    return Column(
      ...
      children: [
        _buildDetailRow('Category', insight.category),
        _buildDetailRow('Budget Amount', formatter.format(insight.budgetAmount)),
        _buildDetailRow('Spent Amount', formatter.format(insight.spentAmount)),
        _buildDetailRow(
          'Usage', 
  ...
  Widget _buildSavingOpportunityDetails(SavingOpportunityInsight insight) {
    ...
    return Column(
      ...
      children: [
        ...
        _buildDetailRow(
          'Potential Savings', 
          formatter.format(insight.potentialSavings),
