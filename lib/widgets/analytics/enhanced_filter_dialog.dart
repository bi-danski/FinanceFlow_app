    ...
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            Text(
              currencyFormat.format(_absoluteMinAmount),
              style: TextStyle(
                fontSize: 13,
            ...
            const Spacer(),
            Text(
              currencyFormat.format(_absoluteMaxAmount),
              style: TextStyle(
                fontSize: 13,
                color: Colors.grey.shade600,
              ),
        ...
        RangeSlider(
          ...
          divisions: 20,
          labels: RangeLabels(
            currencyFormat.format(_minAmount),
        ...
        Row(
          ...
          children: [
            Text(
              'Min: ${currencyFormat.format(_minAmount)}',
              style: const TextStyle(fontSize: 14),
            ),
            Text(
              'Max: ${currencyFormat.format(_maxAmount)}',
              style: const TextStyle(fontSize: 14),
            ),
          ],
        ),
