          ...
          recommendations.add(
            BudgetRecommendation(
              ...
              details: 'Your actual spending in ${budget.category} is consistently higher than your budget. '
                     'Adjusting your budget to ${currencyFormat.format(recommendedAmount)} (slightly below your current spending) '
          ...
          recommendations.add(
            BudgetRecommendation(
              ...
              details: '$category is an essential expense category that should be included in your budget. '
                     ...
                     '(${currencyFormat.format(recommendedAmount)}) to this category.',
              changeType: 'new',
        ...
        recommendations.add(
          BudgetRecommendation(
            ...
            details: 'Financial experts recommend saving at least 20% of your income. '
                   'Adding a ${currencyFormat.format(recommendedAmount)} monthly savings budget will help you build an emergency fund '
          ...
          if (budget.amount > widget.totalIncome * 0.15) { // More than 15% on discretionary
            ...
            recommendations.add(
              BudgetRecommendation(
                ...
                details: 'Your current budget allocates ${currencyFormat.format(budget.amount)} to ${budget.category}, '
                       'which is relatively high compared to your income. Reducing this to '
                       '${currencyFormat.format(recommendedAmount)} would free up funds for savings or other priorities.',
                changeType: 'decrease',
                ...
                child: Row(
                  children: [
                    if (recommendation.currentAmount > 0) ... [
                      Expanded(
                        child: _buildAmountBox(
                          'Current',
                          formatter.format(recommendation.currentAmount),
                    ...
                    Expanded(
                      child: _buildAmountBox(
                        'Recommended',
                        formatter.format(recommendation.recommendedAmount),
                        colorByImpact,
